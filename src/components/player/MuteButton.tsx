...
function MuteIcon({ muted, ...props }: React.ComponentPropsWithoutRef<'svg'> & { muted: boolean }) {
  return (
    <svg aria-hidden="true" viewBox="0 0 24 24" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" {...props}>
      {muted ? (
        <>
